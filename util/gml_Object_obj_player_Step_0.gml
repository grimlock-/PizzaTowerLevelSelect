/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for gml_Script_magnitude

System.InvalidOperationException: Stack empty.
   at System.Collections.Generic.Stack`1.ThrowForEmptyStack()
   at System.Collections.Generic.Stack`1.Pop()
   at UndertaleModLib.Decompiler.Decompiler.DecompileFromBlock(DecompileContext context, Dictionary`2 blocks, Block block, List`1 tempvars, Stack`1 workQueue) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Decompiler.cs:line 2137
   at UndertaleModLib.Decompiler.Decompiler.DecompileFromBlock(DecompileContext context, Dictionary`2 blocks, Block block) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Decompiler.cs:line 2637
   at UndertaleModLib.Decompiler.Decompiler.<DecompileFromBlock>g__FindActualNameForAnonymousCodeObject|30_2(DecompileContext context, UndertaleCode anonymousCodeObject) in D:\a\UndertaleModTool\UndertaleModTool\UndertaleModLib\Decompiler\Decompiler.cs:line 2413
*/
prevhsp = hsp
prevmove = move
...
if (blur_effect > 0)
    blur_effect--
else if (breakdance_speed >= 0.6 || (state == (165 << 0) && sprite_index == spr_rockethitwall) || mach4mode == 1 || boxxeddash == 1 || state == (16 << 0) || state == (5 << 0) || state == (198 << 0) || state == (193 << 0) || state == (42 << 0) || state == (116 << 0) || (state == (79 << 0) && sprite_index == spr_swingding && swingdingdash <= 0) || state == (108 << 0) || state == (43 << 0) || state == (203 << 0) || state == (187 << 0))
{
...
if (state != (108 << 0) && state != (76 << 0) && (state != (61 << 0) || (tauntstoredstate != (108 << 0) && tauntstoredstate != (76 << 0))) && (state != (84 << 0) || (tauntstoredstate != (108 << 0) && tauntstoredstate != (76 << 0))))
    freefallsmash = -14
...
if (object_index == obj_player1)
{
    ...
    if (!((state == (112 << 0) || state == (297 << 0) || state == (66 << 0) || state == (150 << 0) || state == (292 << 0) || state == (119 << 0) || state == (46 << 0) || state == (98 << 0) || state == (46 << 0) || state == (146 << 0) || state == (95 << 0) || (state == (47 << 0) && (sprite_index == spr_knightpepstart || sprite_index == spr_knightpepthunder)) || instance_exists(obj_fadeout) || (collision_flags & (1 << 0)) > 0)))
    {
...
if (state != (92 << 0))
    stompAnim = 0
if (state == (121 << 0) || (state == (16 << 0) && ghostdash && ghostpepper >= 3) || state == (104 << 0) || state == (97 << 0) || ratmount_movespeed >= 12 || gusdashpadbuffer > 0)
{
    if (macheffect == 0)
    {
        macheffect = 1
...
{
    toomuchalarm1 -= 1
    if (toomuchalarm1 <= 0 && (state == (121 << 0) || (state == (16 << 0) && ghostdash == 1 && ghostpepper >= 3) || state == (104 << 0) || state == (97 << 0) || ratmount_movespeed >= 12 || gusdashpadbuffer > 0))
    {
        with (create_mach3effect(x, y, sprite_index, (image_index - 1)))
        {
            playerid = other.object_index
...
if ((y > (room_height + 300) || y < -800) && (!(place_meeting(x, y, obj_verticalhallway))) && restartbuffer <= 0 && (!verticalhallway) && room != custom_lvl_room && state != (89 << 0) && state != (186 << 0) && (!global.levelreset) && room != boss_pizzaface && room != tower_outside && room != boss_pizzafacefinale && state != (89 << 0) && (!instance_exists(obj_backtohub_fadeout)) && state != (290 << 0))
{
    if (room != Mainmenu && room != tower_outside && room != Realtitlescreen && room != Longintro && room != Endingroom && room != Johnresurrectionroom && room != Creditsroom && room != rank_room)
    {
		...
		var s = concat("x ", string(x), "  y ", string(y), "   lv ", global.leveltosave)
		with (create_transformation_tip(s))
		{
			depth = -700
			alarm[1] = 100
		}
